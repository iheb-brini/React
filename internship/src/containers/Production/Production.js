...
class Production extends Component {
  ...
  confirmDeletetion() {
    ...
    let id= this.props.modal.productID;
  ...
  render() {
      ...
      crud = (
        <Switch>
          <Route
            ...
            render={() => <ProductCreate {...this.props} />}
          />
          <Route
            path={this.props.match.url + "/delete"}
            render={() => <ProductDelete {...this.props} />}
          />
          <Route
            path={this.props.match.url + "/update/:id"}
            render={() => <ProductUpdate {...this.props} />}
          />
          <Route
            ...
            render={() => (
              <Aux>
                <Modal
                  ...
                  modalClosed={this.cancelDeletetion.bind(this)}
                >
                  <p>Are you sure?</p>
                  <Button
                    btnType="Success"
                    clicked={this.confirmDeletetion.bind(this)}
                  >
                    CONFIRM
                  </Button>
                  <Button
                    btnType="Danger"
                    clicked={this.cancelDeletetion.bind(this)}
                  >
                    CANCEL
                  </Button>
                </Modal>
    ...
    return <div className={classes["container"]}>{crud}</div>;
  }
}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withErrorHandler(Production, axios));
